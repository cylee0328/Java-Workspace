...
public class FunctionTest {
	...
	public static void main(String[] args) {
		...
		// 6) toXXXBiFuntcion<T,U> : T,U를 인자로 받아서 XXX를 리턴
		
		// 객체배열을 통한 람다식 실습
		//1) 핸드로 객체배열 만들기
		ArrayList<Product> pList = new ArrayList<Product>();
		pList.add(new Product("갤럭시 z플립4", 1350000, 55));
		pList.add(new Product("갤럭시 z플립3", 1250000, 15));
		pList.add(new Product("갤럭시 z플립2", 1150000, 35));
		pList.add(new Product("갤럭시 z플립1", 1000000, 45));
		pList.add(new Product("아이폰 14", 1500000, 25));
...
//	public static void static printProduct(ArrayList<Product>) pList, ToIntFunction<Product> toIntFunction) {
//		for(Product p : pList) {
