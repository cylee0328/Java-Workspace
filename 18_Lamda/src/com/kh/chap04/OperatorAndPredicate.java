...
public class OperatorAndPredicate {
	 ...
	 * Operator 인터페이스 특징
	 * 1. 단순연산시 사용
	 * 2. 받아온 타입, 혹은 인자를 통해 계산을 하고 해당타입 그래도 반환.
	 * 
	 * Predicate 특징
	...
	public static void main(String[] args) {
		...
		// Predicate<T> : T형을 인자로 받아서 true or false 값을 리턴.
