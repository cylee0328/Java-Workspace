...
public class C_Cast {
	 ...
	 *  
	 *  형변환의 종류
	 *  1. 자동형변환 => 자동으로 형변환이 진행되기 때문에 내가 직접 형변환할 필요없음.
	...
	public void autoCasting() {
		...
		int i1 = 10;
		double d1 = (double)i1; // 자동으로 형변환 되있음.
								// 컴퓨터 포장용 상자에 휴대폰을 담은꼴과 비슷함.
		...
		//정수가 실수로 담길때에는 큰 사이즈의 정수여도 작은 사이즈의 실수변수에 대입 가능.
		...
		/*
		 * char의 범위 0~65xxxx : 각 문자마다 고유의 정수값이 정해져있음. 따라사 쌍방향 변환이
		 * 가능하다. 음수값은 오류가 난다.
		 * 참고 : 아스키코드표(0~127, 영문자, 대소문자, 숫자, 특수문자)
		 * 		유니코드표(0 ~ 65xxx, 영어, 숫자, 특수문자, 한글, 그 외 언어)
		 */
		System.out.println((int)'충');
