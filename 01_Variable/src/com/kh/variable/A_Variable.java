...
//시급, 근무시간, 근무일수를 곱해서 월급을 계산하여 출력하는 메소드
public class A_Variable {
	...
	public void printVariable() {
		...
		// 이충영 : 00000원입니다.
		// * 은 곱셈을 나타내는 연산자
		// 서로 다른 자료형 값 여러개를 출력문 하나에 동시에 출력 시 +로 붙여줘야함.
		
		System.out.println("이충영 : "+11000 * 4 * 5+"원 입니다.");
		...
		int pay = 11000; // 자바에서 = 은 대입을 나타내는 연산자. 같다는 == 사용함.
		int time = 6;
		int day = 15;
		...
		System.out.println("이충영 님의 월급은 : " + pay*time*day + "원 입니다.");
		System.out.println("홍길동 님의 월급은 : " + pay*time*day + "원 입니다.");
		System.out.println("고길동 님의 월급은 : " + pay*time*(day+5) + "원 입니다.");
		...
		// 변수의 선언
		public void delclareVariable() {
			/*
			 * 변수의 선언(값을 기록하기 위한 변수를 메모리 공간에 확보해두겠다 = 박스르 만들겠다.)
			 * [표현법] 자료형 변수명;
			 * 
			 * 자료형 : 어떤 값을 담아낼지, 어떤 크기의 값을 담아낼지에 따라서 변수의 크기및 모양을 지정하는 부분.
			 * 변수명 : 변수의 이름을 정하는 부분.
			 * 
			 * 주의할 점
			 * 1. 변수명은 소문자로 시작하게끔 지어줄 것.(단, 낙타등 표기법지키키)
	...
	public void constantVariable() {
		...
		final int AGE = 20; //final 입력시 변수명 대문자로 입력이 관례.
