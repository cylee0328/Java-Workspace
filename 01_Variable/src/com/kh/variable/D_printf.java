...
public class D_printf {
	...
	public void printfTest() {
		...
		System.out.printf("%-5d ㅁㄴㅍ \n", iNum1); // %-5d : 5칸의 공간 중 왼쪽 정렬(음수)
		
		// 실수 테스트
		double dNum = 4.12345678;
		System.out.printf("dNum : %f \n", dNum);
		// %f : 소숫점 아래 7번째 줄에서 반올림되어 소숫점 아래 6번째 까지만 출력됨.
		
		System.out.printf("dNum : %.1f \n", dNum);
		// %.1f : 소숫점아래 2번째 줄에서 반올림되어 소숫점아래 1번째까지만 출력됨.
		// .자릿수로 제어 가능
		
		// printf : 포맷 한번으로 간편하게 출력가능.
		// 단, 지정한 포맷의 갯수, 종류, 뒤에오는 변수의 갯수와 종류가 정확하게 일치해야함.
