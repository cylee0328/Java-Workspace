...
public class B_Switch {
	 ...
	 * switch 조건식 => 정확한 값의 조건만 기술(동등비교만 가능)
	 * 
	 * [표현법]
	 * switch(앞으로 동등비교할 대상자) {
	 * case 값1 : 실행할 코드1; // 앞으로 동등비교를 할 대상자 == 값1일 경우 실행할 코드.
	 * 			 break; // 실행할 코드1만 실행하고 switch문을 빠져나갈지 결정할 키워드
	 * 	//브레이크문이 없다면 이 아래코드도 계속 실행됨.
	 * case 값2 : 실행할 코드2;
	 * 			 break;
	 * case 값n : 실행할 코드n;
	 * 			 break;
	 ...
	 * 					  // 위의 값1, 값2, 값n... 앞으로 동등비교를할 대상과 하나도 일치하지 않다면
...
//		}
	...
	public void method2() {
		...
		// 각 과일마다의 가격을 출력할 것 (사과 1000, 바나나 2000, 복숭아5000)
		
		Scanner sc = new Scanner(System.in);
		System.out.print("구매할 과일을 적으시오 : ");
