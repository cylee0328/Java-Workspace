...
public class B_ArrayCopy {
	...
	public void method1() {
		...
		// 이유는 얕은 복사가 이루어 졌기 때문 => 배열의 주소값이 복사되어
		// 원본과 복사본은 사실상 동일한 데이터를 가지고 있다.
		System.out.println("\n원본배열의  해시코드 : " + origin.hashCode());
...
//		System.arraycopy(origin, 2, copy, 9, 2);
	...
	public void method4() {
		...
		/*
		 * 2. System.arraycopy 메소드 : 몇 번 인덱스부터 몇 개를 어느 위치의 인덱스에 복사 할 것인지 세밀하게 지정가능.
		 * 
		 * 3. Arrays.copyOf 메소드 : 무조건 원본 배열의 0번 인덱스부터 내가 제시한 갯수만 큼 복사 진행됨.
		 * 						   내가 제시한 길이가 원본배열보다 크다면 나머지에는 0의값으로 채워서 복사해줌.
		 */
	}
	...
	public void method5() {
		...
		/*
		 * Array.toString(배열)
		 * -> 앞과 뒤에 [] 각 값마다 ,를 넣어서 하나의 문자열로 연이서서 출력해주는 메서드
		 */
