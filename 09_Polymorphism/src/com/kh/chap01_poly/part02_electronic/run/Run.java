...
import com.kh.chap01_poly.part02_electroni.controller.ElectronicController1;
import com.kh.chap01_poly.part02_electroni.controller.ElectronicController2;
...
//		// 생성과 동시에 이 클래스의 필드값(desk, tab, note)들이 메모리에 null값으로 추가됨.
//		
...
//		System.out.println(t);
		...
		ec.insert(new Desktop("삼성", "데탑", 999999, "지포스1070"), 0);
		ec.insert(new NoteBook("엘지", "그램", 11111, 4), 1);
