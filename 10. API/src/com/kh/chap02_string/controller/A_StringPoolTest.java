...
public class A_StringPoolTest {
	...
	public void method1() {
		...
		// String 클래스의 hashCod()메소드의 경우 주소갑 기반이 아닌 실제 담긴 문자열 기반으로 해시코드 값을
		// 반환하도록 오버라이딩 되어있음.
		
		// 정말 주소값을 알고 싶을 때 사용하는 메서드 System.identityHashCode(참조변수(레퍼런스변수));
	...
	public void method3() {
		 ...
		 * 기존의 그 자리(원래있던 주소값)에서 수정이되는 개념이 아니라는것
		 *  매번 새로운 주소값을 참조하게됨.
		 *  
		 */
